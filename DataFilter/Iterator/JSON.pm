package DataFilter::Iterator::JSON;
...
use base 'DataFilter::Iterator';

=head1 NAME

DataFilter::Iterator::JSON - Iterator class for JSON strings and files
...
=head1 SYNOPSIS
    ...
    $json_iter = DataFilter::Iterator::JSON->new($json);

    $json_iter->next();

    $json_iter_file = DataFilter::Iterator::JSON->new(file => 'fruits.json');

=head1 DESCRIPTION

DataFilter::Iterator::JSON is a subclass of L<DataFilter::Iterator>.

=head1 CONSTRUCTOR

=head2 new

Creates an DataFilter::Iterator::JSON object from a JSON string.
