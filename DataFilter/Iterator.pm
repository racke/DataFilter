...
DataFilter::Iterator - Generic iterator class for DataFilter
...
=head1 SYNOPSIS
    ...
    $iter = new DataFilter::Iterator($cart);
...
Creates a DataFilter::Iterator object. The elements of the
