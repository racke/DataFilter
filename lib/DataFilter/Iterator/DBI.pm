package DataFilter::Iterator::DBI;
...
DataFilter::Iterator::DBI - DBI Iterator class for DataFilter
...
Create a DataFilter::Iterator::DBI object with the following parameters:
